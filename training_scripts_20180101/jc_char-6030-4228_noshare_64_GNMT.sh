...
cd ${NMT_ROOT}
MODEL_ROOT=/clwork/vincentzlt/tf-nmt/models-2018
MODEL=jc_char-6030-4228_noshare_64_GNMT
...
CORPUS=char # ('char','subword','mecab-jieba','comp','stroke')
SHARE_VOCAB=false
MODEL_TYPE=GNMT
SUBWORD_OPTION=
TEXT_FORMAT=
...
CUDA_VISIBLE_DEVICES=0 python3 -m nmt.nmt \
    --src=jp \
    --tgt=cn \
